...
import EonomicPaymnet from "./EonomicPaymnet";

const SeatBooking = ({ EconomicPrice, name }) => {
  ...
  const totalPrice = value.length * EconomicPrice;
  ...
  return (
    <div className="my-5">
      ...
      <EonomicPaymnet totalPrice={totalPrice} totalSeat={totalSeat} value={value} name={name}/>
    </div>
  );
};
