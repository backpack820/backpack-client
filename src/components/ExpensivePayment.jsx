...
const ExpensivePayment = ({ totalPrice, totalSeat, value, name }) => {
  ...
  const handlePayment = (event) => {
    ...
    // console.log({ userEmail, cardNumber, cardExpire, cvc, holderName, totalPrice, totalSeat, value, name });
  };
  return (
    <Fragment>
      ...
      >
        <DialogHeader className="capitalize text-xl">Your Destination: {name}</DialogHeader>
        <DialogBody divider>
...
export default ExpensivePayment;
