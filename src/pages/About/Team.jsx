      ...
      <div className="grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800">Chief Manager</p>
          </div>
        </div>
        <div className="flex">
          <img
        ...
        <div className="flex">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800">Division Manager</p>
          </div>
        </div>
        <div className="flex">
          <img
        ...
        <div className="flex">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800">Account Manager</p>
          </div>
        </div>
        <div className="flex">
          <img
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800">Chief Executive Office Director</p>
          </div>
        </div>
        <div className="flex">
          <img
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800"> Marketing Director</p>
          </div>
        </div>
        <div className="flex">
          <img
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800"> Tour Planner</p>
          </div>
        </div>
      </div>
    </div>
